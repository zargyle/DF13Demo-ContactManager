/*
 * jQuery.validity ÃƒÂ¯Ã‚Â»Ã‚Â¿v1.2.0
...
(function($, undefined) {
    ...
    $.validity = {
        ...
        patterns:{
            ...
            multiDate:/^(((0?\d)|(1[012]))\/([012]?\d|30|31)\/\d{1,4})|(\d{4}\-\d{2}\-\d{2})$/,
            dateSFStrict: /\d{4}\-\d{2}\-\d{2}/, 
            ...
            zip:/^\d{5}(-\d{4})?$/,
            //JK 09/12/2012: Changed RegEx on Phone to be more flexable
            //regEx obtained through http://blog.stevenlevithan.com/archives/validate-phone-number
    ...
    $.fn.extend({
        ...
        require:function(msg) {
            return validate(
                ...
                function(obj) {
                    var val = $(obj).val();
                    //JK 9/13/2012 with IE 8.0 val is coming back an object with 
                    //the value in slot [0] for selects this will fix this 
            ...
            return validate(
                ...
                $.isFunction(rule) ?
                    ...
                    function(obj) {
                        ...
                        if(obj.validationMessage !== undefined && obj.validationMessage !== null && obj.validationMessage !== '') {
                            //native html5 error, great for dates
                            return false;
                        }
